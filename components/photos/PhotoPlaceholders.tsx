export function PhotoCongregation() {
  return (
    <svg viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      ...
      <g fill="#1E0F0C" opacity="0.92">
        <ellipse cx="120" cy="640" rx="70" ry="90"/><ellipse cx="120" cy="540" rx="38" ry="42"/>
        <ellipse cx="240" cy="660" rx="80" ry="100"/><ellipse cx="240" cy="555" rx="44" ry="46"/>
        <ellipse cx="380" cy="650" rx="74" ry="92"/><ellipse cx="380" cy="548" rx="40" ry="44"/>
        <ellipse cx="520" cy="660" rx="80" ry="100"/><ellipse cx="520" cy="552" rx="44" ry="48"/>
        <ellipse cx="660" cy="650" rx="74" ry="94"/><ellipse cx="660" cy="548" rx="40" ry="44"/>
        <ellipse cx="800" cy="660" rx="82" ry="100"/><ellipse cx="800" cy="552" rx="46" ry="48"/>
        <ellipse cx="940" cy="650" rx="74" ry="92"/><ellipse cx="940" cy="548" rx="40" ry="44"/>
        <ellipse cx="1080" cy="660" rx="80" ry="100"/><ellipse cx="1080" cy="555" rx="44" ry="46"/>
      </g>
...
export function PhotoPastor() {
  return (
    <svg viewBox="0 0 800 1000" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      <defs>
...
export function PhotoWorship() {
  return (
    <svg viewBox="0 0 800 600" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      <defs>
...
export function PhotoPrayer() {
  return (
    <svg viewBox="0 0 600 800" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      <defs>
...
export function PhotoChildren() {
  return (
    <svg viewBox="0 0 600 800" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      ...
      <g fill="#1E0F0C" opacity="0.92">
        <ellipse cx="160" cy="700" rx="60" ry="100"/><circle cx="160" cy="560" r="42"/>
        <ellipse cx="300" cy="710" rx="68" ry="110"/><circle cx="300" cy="558" r="48"/>
        <ellipse cx="440" cy="700" rx="60" ry="100"/><circle cx="440" cy="560" r="42"/>
      </g>
...
export function PhotoYouth() {
  return (
    <svg viewBox="0 0 600 800" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      ...
      <g fill="#1E0F0C" opacity="0.95">
        <ellipse cx="120" cy="700" rx="65" ry="105"/><circle cx="120" cy="555" r="44"/>
        <ellipse cx="260" cy="710" rx="72" ry="115"/><circle cx="260" cy="552" r="50"/>
        <ellipse cx="400" cy="710" rx="72" ry="115"/><circle cx="400" cy="552" r="50"/>
        <ellipse cx="540" cy="700" rx="65" ry="105"/><circle cx="540" cy="555" r="44"/>
      </g>
    </svg>
  );
}

export function PhotoWomen() {
  return (
    <svg viewBox="0 0 600 800" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      <defs>
...
export function PhotoMen() {
  return (
    <svg viewBox="0 0 600 800" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      ...
      <g fill="#1E0F0C" opacity="0.92">
        <ellipse cx="160" cy="520" rx="80" ry="120"/><circle cx="160" cy="370" r="50"/>
        <ellipse cx="300" cy="500" rx="85" ry="130"/><circle cx="300" cy="350" r="55"/>
        <ellipse cx="440" cy="520" rx="80" ry="120"/><circle cx="440" cy="370" r="50"/>
      </g>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 600 800" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      ...
      <g fill="#FFE0A8" opacity="0.8">
        <circle cx="200" cy="280" r="10"/><rect x="208" y="220" width="3" height="65"/>
        <circle cx="380" cy="220" r="10"/><rect x="388" y="160" width="3" height="65"/>
        <circle cx="460" cy="320" r="10"/><rect x="468" y="260" width="3" height="65"/>
      </g>
    </svg>
  );
}

export function PhotoSenior() {
  return (
    <svg viewBox="0 0 600 800" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      <defs>
      ...
      <g fill="#1E0F0C" opacity="0.95">
        <ellipse cx="220" cy="700" rx="80" ry="120"/><circle cx="220" cy="540" r="55"/>
        <ellipse cx="380" cy="700" rx="80" ry="120"/><circle cx="380" cy="540" r="55"/>
      </g>
...
export function PhotoEvent({ tone = 'maroon' }: { tone?: 'maroon' | 'amber' | 'blue' | 'dark' }) {
  ...
  const id = `pe-${tone}`;
  const [a, b] = grads[tone] ?? grads.maroon;
  return (
    <svg viewBox="0 0 800 600" preserveAspectRatio="xMidYMid slice" className="w-full h-full" aria-hidden="true">
      <defs>
      ...
      <g opacity="0.20" fill="#FFE0A8"><circle cx="650" cy="120" r="80"/></g>
      <g fill="#1E0F0C" opacity="0.85">
        <ellipse cx="200" cy="540" rx="60" ry="80"/><circle cx="200" cy="420" r="36"/>
        <ellipse cx="320" cy="550" rx="68" ry="90"/><circle cx="320" cy="420" r="40"/>
        <ellipse cx="450" cy="540" rx="60" ry="80"/><circle cx="450" cy="420" r="36"/>
        <ellipse cx="570" cy="550" rx="68" ry="90"/><circle cx="570" cy="420" r="40"/>
      </g>
    </svg>
  );
}

/* Generic photo placeholder for sub-pages */
export function Photo({
  ...
  return (
    <svg viewBox={`0 0 ${w} ${h}`} preserveAspectRatio="xMidYMid slice" style={{ width: '100%', height: '100%', display: 'block' }} aria-hidden="true">
      <defs>
        <linearGradient id={`pg-${theme}-${w}`} x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor={c[0]}/><stop offset="60%" stopColor={c[1]}/><stop offset="100%" stopColor={c[2]}/>
        </linearGradient>
        <radialGradient id={`pl-${theme}-${w}`} cx="30%" cy="25%" r="60%">
          <stop offset="0%" stopColor="rgba(255,235,200,0.32)"/>
          <stop offset="60%" stopColor="rgba(255,235,200,0)"/>
        </radialGradient>
      </defs>
      <rect width={w} height={h} fill={`url(#pg-${theme}-${w})`}/>
      <rect width={w} height={h} fill={`url(#pl-${theme}-${w})`}/>
      <g opacity="0.10" fill="#F4F1EC">
        ...
        <rect x={w * 0.06} y={h * 0.70} width={w * 0.28} height={h * 0.025} rx="2"/>
      </g>
    </svg>
  );
}
